...
Use this when deploying with a custom image (for example containing ERPNext + HRMS + BuildSuite Core + ProjectIT) and managed MariaDB/Redis in one Compose app.
